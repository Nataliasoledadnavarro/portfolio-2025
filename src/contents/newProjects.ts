...
export const newProjects: NewProjectProps[] = [
  {
    ...
    description:
      "Sitio interactivo de invitación digital con animaciones, diseño personalizado y experiencia responsive. Incluye integración con WhatsApp y Google Calendar para confirmar asistencia y agendar el evento.",
    image: "/img/project_birthday.svg",
    tag: { variant: "primary", name: "Creativo" },
    githubLink: "https://github.com/Nataliasoledadnavarro/invitacion_cumple",
    demoLink: "https://cumplo41.netlify.app/",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    tag: { variant: "secondary", name: "Estrategia" },
